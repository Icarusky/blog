...
let convert;
try {
	convert = __webpack_require__(8).convert;
} catch (e) {}
...
var _require$1 = __webpack_require__(5);
...
var _require$2 = __webpack_require__(6);
...
var _require$3 = __webpack_require__(1);
...
var iconvLite = __webpack_require__(9);
...
var bomHandling = __webpack_require__(10),
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __webpack_require__(11); // Lazy load all encoding definitions.
...
if (nodeVer) {
    ...
    if (nodeVerArr[0] > 0 || nodeVerArr[1] >= 10) {
        __webpack_require__(26)(iconv);
    }

    // Load Node primitive extensions.
    __webpack_require__(27)(iconv);
}
...
var StringDecoder = __webpack_require__(13).StringDecoder;
...
module.exports = {
    ...
    'cp936': {
        type: '_dbcs',
        table: function() { return __webpack_require__(2) },
    },

    // GBK (~22000 chars) is an extension of CP936 that added user-mapped chars and some other.
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(2).concat(__webpack_require__(3)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'gb18030': {
        type: '_dbcs',
        table: function() { return __webpack_require__(2).concat(__webpack_require__(3)) },
        gb18030: function() { return __webpack_require__(23) },
        encodeSkipVals: [0x80],
        encodeAdd: {'€': 0xA2E3},
    },
    ...
    'cp950': {
        type: '_dbcs',
        table: function() { return __webpack_require__(4) },
    },
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(4).concat(__webpack_require__(25)) },
